...
function preload(){
  ...
  green_balloonImage = loadImage("green_balloon0.png");// carregue a imagem do balão verde
 pink_balloonImage = loadImage("pink_balloon0.png"); // carregue a imagem do balão rosa
  blue_balloonImage = loadImage("blue_balloon0.png"); // carregue a imagem do balão azul
...
function blueBalloon() {
 ...
 blue.addImage(blue_balloonImage);
  blue.velocityX = 3;
  blue.lifetime = 150;
  blue.scale = 0.1;//crieSprite para o balão
...
pink.addImage(pink_balloonImage);
   pink.velocityX = 3;
   pink.lifetime = 150;
  pink.scale = 0.1;//crieSprite para o balão
  //adicioneImagem para o balão
  // adicione velocidade para fazer o balão se mover
  // mudar a dimensão do balão
  // atriubua tempo de vida ao balão
